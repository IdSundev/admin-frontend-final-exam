        ...
        <div className="row mt-4 mb-4">
          <div className="col-12">
            <center>
              ...
              <Link to={`/admin/requests/${this.props.links.previous}`}>
                <button
                  className="btn btn-outline-primary mr-2"
                  style={{ background: "white" }}
                >
              ...
              {this.props.links.pages.map((page, idx) => {
                ...
                if (page === parseInt(this.props.pageSelected)) {
                  ...
                  return (
                    <Link to={`/admin/requests/${page}`} key={idx}>
                      <button
              ...
              <Link to={`/admin/requests/${this.props.links.next ? this.props.links.next : this.props.links.last_page}`}>
