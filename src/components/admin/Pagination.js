        ...
        <div className="row mt-4 mb-4">
          <div className="col-12">
            <center>
              ...
              <Link to={`/admin/admin/${this.props.links.previous}`}>
                <button
                  className="btn btn-outline-primary mr-2"
                  style={{ background: "white" }}
                >
              ...
              {this.props.links.pages.map((page, idx) => {
                ...
                if (page === parseInt(this.props.pageSelected)) {
                  ...
                  return (
                    <Link to={`/admin/admin/${page}`} key={idx}>
                      <button
              ...
              <Link to={`/admin/admin/${this.props.links.next ? this.props.links.next : this.props.links.last_page}`}>
                <button className="btn btn-outline-primary ml-2">&gt;</button>
              </Link>
              <Link to={`/admin/admin/${this.props.links.last_page}`}>
