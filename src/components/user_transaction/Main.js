...
export default class Main extends Component {
  ...
  getUserTransaction = () => {
    axios
      .get(
        `${url_backend}/user-transaction?page=${this.props.page}`
      )
      .then((res) => {
        console.log(res)
        this.setState({ userTransaction: res.data.userTransaction });
                ...
                <div className="card card-primary">
                  ...
                  <div className="card-body" style={{ display: "block" }}>
                    <table className="table table-striped ">
                      ...
                      <tbody>
                        {this.state.userTransaction.map((request, idx) => {
                          return (
                            <tr
                              key={idx}
                              className={
                            ...
                            >
                              ...
                              <td>
                                <Link
                                  to={`/admin/transactions/detail/${request.id_transaction}`}
                                >
                              ...
                              <td>
                                <Link
                                  to={`/admin/user-transaction/detail/${request.id_request}`}
                                >
                                  <button className="btn btn-primary btn-sm">
                                    Detail
                                  </button>
